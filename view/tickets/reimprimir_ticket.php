...
//cargar la informacion del ticket con el id recibido desde principal
$id_ticket_get = $_GET['id'];

$sql_tickets = "SELECT * FROM tb_tickets WHERE estado_ticket = 1 and id_ticket = $id_ticket_get";
